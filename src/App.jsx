...
<div
  ...
  >
   ...
   <div className="bg-black shadow-lg flex flex-col justify-center items-center w-full h-auto py-6 gap-4 mb-6">
...
<div className="bg-gray-500 shadow-lg flex flex-col justify-center items-center max-w-xl mx-auto py-6 gap-4 rounded-xl mb-6">
 ...
 <h1 className="font-bold text-white text-center text-lg ">
    ...
    <div className="flex gap-4">
      ...
      <button
        className="px-6 py-3 bg-red-700 text-white font-semibold rounded-xl" onClick={filterGuerreiro}>  
        Recrutar Guerreiro
      </button>

      <button
        className="px-6 py-3 bg-yellow-500 text-white font-semibold rounded-xl" onClick={filterArqueira}>  
        Recrutar Arqueira
      </button>
    </div>
  </div>
